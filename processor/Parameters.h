...
public:
    ...
    float sampleRateReduction = 44100.0f;
    AudioParameterFloat* sampleRateParam;

    float bitDepthReduction = 16.0f;
    AudioParameterFloat* bitDepthParam;

    LFO crushLFO;
    AudioParameterChoice* crushLFOTypeParam;
    AudioParameterFloat* crushLFORateParam;
    AudioParameterFloat*  crushLFOAmountParam;
    AudioParameterBool*  crushLFOInvertParam;

private:
    AudioProcessorValueTreeState& tree;

    LinearSmoothedValue<float> mixSmoother;
    LinearSmoothedValue<float> sampleRateSmoother;
    LinearSmoothedValue<float> bitDepthSmoother;
    LinearSmoothedValue<float> crushLFOAmountSmoother;
