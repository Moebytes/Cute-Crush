...
public:
    ParameterID mix;
    ParameterID sampleRate;
    ParameterID bitDepth;
    ParameterID crushLFOType;
    ParameterID crushLFORate;
    ParameterID crushLFOAmount;
    ParameterID crushLFOInvert;
    ...
    static auto loadFromJSON() -> ParameterIDs {
        ...
        parameterIDs.mix = getParameter("mix");
        parameterIDs.sampleRate = getParameter("sampleRate");
        parameterIDs.bitDepth = getParameter("bitDepth");
        parameterIDs.crushLFOType = getParameter("crushLFOType");
        parameterIDs.crushLFORate = getParameter("crushLFORate");
        parameterIDs.crushLFOAmount = getParameter("crushLFOAmount");
        parameterIDs.crushLFOInvert = getParameter("crushLFOInvert");
